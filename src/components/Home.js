        ...
        <div>
            ...
            <div className="scrolloff">
                ...
                <div className="row">
                    ...
                    <div className="col-md-6 mediaqueryspec">
                ...
                <div className="row mediaquerythree">
                    <div className="col-md-6">
                        <h1 className="ProjectHeadTwo text-center">Latest Projects</h1>
                    </div>
                    <div className="col-md-6">
                        <h6 className="ProjectHeadTwo">
                ...
                {/* <!-- <div className="row rowmargin">
            <div className="col-md-12 paddingCol">
                <div className="row">
                    <div className="col-md-3 d-flex justify-content-center mediaquery">
